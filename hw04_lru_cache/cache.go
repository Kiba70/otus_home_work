...
type lruCache struct {
	...
	lock     sync.Mutex // we do not use sync.RWMutex because in the Get function we are making modification
}

// adds new value (or updates existing one) to cache based on key.
